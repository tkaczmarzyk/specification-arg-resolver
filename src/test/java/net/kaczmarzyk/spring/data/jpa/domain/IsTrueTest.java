 ...
 */
public class IsTrueTest extends IntegrationTestBase {
    ...
    public void filtersByTrueValueOfPrimitiveBooleanType() {
        //given
        IsTrue<Customer> goldenCustomers = new IsTrue<>(queryCtx, "gold", new String[0]);
    ...
    public void filtersByTrueValueOfObjectBooleanType() {
        //given
        IsTrue<Customer> goldenCustomers = new IsTrue<>(queryCtx, "goldObj", new String[0]);
    ...
    public void equalsAndHashCodeContract() {
        //when + then
        EqualsVerifier.forClass(IsTrue.class)
                .usingGetClass()
    ...
    public void toStringVerifier() {
        //when + then
        ToStringVerifier.forClass(IsTrue.class)
