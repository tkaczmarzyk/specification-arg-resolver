 ...
 *
 */
public class InIgnoreCaseLocaleIntegrationTest extends IntegrationTestBase {
    ...
    public void filtersIgnoringCaseAccordingToDbCollation() {
        InIgnoreCase<Customer> simpsons = new InIgnoreCase<>(queryCtx, "lastName", new String[]{"simpson"}, defaultConverter);
    ...
    public void filtersIgnoringCaseAccordingToDbCollation_turkishCapitalI() {
        InIgnoreCase<Customer> simpsons = new InIgnoreCase<>(queryCtx, "lastName", new String[]{"SİMPSON"}, defaultConverter);
        simpsons.setIgnoreCaseStrategy(IgnoreCaseStrategy.DATABASE_UPPER);
        List<Customer> simpsonsFound = customerRepo.findAll(simpsons);
