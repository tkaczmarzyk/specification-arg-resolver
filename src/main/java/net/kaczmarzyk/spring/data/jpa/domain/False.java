 ...
 * This can be also achieved with `Equal` specification. `False` is a convenience-class to emphasize boolean attributes.</p>
 *
 * <p>Requires boolean parameter.</p>
 *
 * @author Hubert Gotfryd (Tratif sp. z o.o.)
 */
public class False<T> extends PathSpecification<T> {
    ...
    public False(QueryContext queryContext, String path, String[] httpParamValues, Converter converter) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(expectedValue, aFalse.expectedValue) &&
                Objects.equals(converter, aFalse.converter);
    }
